...
app.get('/', (req, res) => {
    res.json({
        ...
        endpoints: {
            ...
            marketing: {
                create: 'POST /api/marketing',
                getAll: 'GET /api/marketing',
                getOne: 'GET /api/marketing/:id',
                update: 'PUT /api/marketing/:id',
                delete: 'DELETE /api/marketing/:id',
                send: 'POST /api/marketing/:id/send'
            }
        }
    });
});
...
// ✅ Test route for marketing (no auth required)
app.get('/api/marketing-test', (req, res) => {
    res.json({ success: true, message: 'Marketing route is working!' });
});
